...
from catalyst.dl.callbacks import LRFinder
from catalyst.core.registry import CALLBACKS
...
class LRFinderLogger(LRFinder):
    ...
    def on_batch_end(self, state):
        self.lr_history.append(self._calc_lr())
        self.loss_history.append(state.metric_manager.batch_values['loss'])
        super().on_batch_end(state)

CALLBACKS.add(LRFinderLogger)
