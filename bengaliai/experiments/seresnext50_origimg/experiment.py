...
from .parquet2zip import parquet_to_images
from bengaliai.config import *
from .config import experiment_config
from ...gridmask import GridMask

ZIP_TRAIN_FILE = f'train_orig.zip'
ZIP_TEST_FILE = f'test_orig.zip'
...
def run(
    ...
    parquet_to_images(TRAIN, ZIP_TRAIN_FILE)
    parquet_to_images(TEST, ZIP_TEST_FILE)
